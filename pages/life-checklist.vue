  ...
  <div class="container mx-auto flex justify-center">
    <div class="flex flex-col w-full justify-center py-8 gap-y-3">
      <Header title="life checklist">
        <p>
          a shameless clone of
          <a href="https://twitter.com/nealagarwal" target="_blank"
            >Neal Agarwal</a
          >'s
          <a href="https://neal.fun/life-checklist/" target="_blank"
            >life checklist</a
          >
        </p>
      ...
      <div class="gap-2 grid grid-cols-2 md:grid-cols-3">
        <LifeChecklistCheckItem
          v-for="(item, index) in lifeItems"
          :key="index"
          :item="item"
          :index="index"
          :clickedIndex="itemClicked"
          :items="checkedItems"
        />
      </div>
      <LifeChecklistProgressFooter
